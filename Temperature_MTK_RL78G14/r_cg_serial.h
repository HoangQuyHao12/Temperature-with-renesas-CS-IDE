...
#define _4A00_CSI21_DIVISOR              (0x4A00U)
...
MD_STATUS Temperature_Get(Temperature_Data *data);
extern void Temperature_Display(void);
extern void Temperature_Display(void);
extern void Average_10tGetData(void);
